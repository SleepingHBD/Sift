...
- Evidence-scoped Signals workspace for recording working observations and hypotheses, linking original project sources as support/contradiction/context, preserving source rationales and visible scope qualifiers, and creating transparent append-only assessments without automatically promoting trends
