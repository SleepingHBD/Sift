...
- Cloud-backed Radar monitors, source-level collection health and run diagnostics, database-calculated coverage and headline metrics, normalized conversations, notes, saved and important markers, and evidence relationships with views for timelines, topics, spikes, source detail, and evidence
