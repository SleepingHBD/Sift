...
import type { StrategyStageSourceRecord } from "@/lib/strategy-pipeline/types";

export function StrategySourceDrawer({ source, onClose }: { source: StrategyStageSourceRecord | null; onClose: () => void }) {
