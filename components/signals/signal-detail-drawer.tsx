...
export function SignalDetailDrawer({ signal, projectName, onClose, onUpdated }: SignalDetailDrawerProps) {
    ...
    <div className="radar-overlay radar-overlay--drawer" role="dialog" aria-modal="true" aria-labelledby="signal-detail-title">
      ...
      <aside className="radar-drawer signal-detail-drawer">
        ...
        {status === "ready" ? <>
          ...
          <SignalAssessmentPanel snapshots={snapshots} evidenceCount={links.length} pending={pending === "assessment"} onCreate={() => void assess()} />
        </> : null}
